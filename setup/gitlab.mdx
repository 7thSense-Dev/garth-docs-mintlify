...
<Steps>
  ...
  ![GitLab integration settings showing token validation](/images/setup/gitlab_PAT_integration.png)
  ...
  <Step title="Install repositories">
    ...
    ![GitLab integration settings showing repository selection and Install Repositories button](/images/setup/gitlab_integration.png)
