...
<Steps>
  ...
  <Step title="Bind the token">
    ...
    <Frame caption="Enter your Bitbucket URL, username, and Personal Access Token, then click Validate">
      <img src="/images/setup/bitbucket_PAT_integration.png" alt="Bitbucket integration settings showing token validation" />
    </Frame>
  ...
  <Step title="Install repositories">
    ...
    <Frame caption="Select the repositories you want Garth to review and click Install Repositories">
      <img src="/images/setup/bitbucket_integration.png" alt="Bitbucket integration settings showing repository selection and Install Repositories button" />
    </Frame>
