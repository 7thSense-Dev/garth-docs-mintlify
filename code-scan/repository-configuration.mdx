...
To configure settings for a specific repository, navigate to [**Agent Setup → Repository Review**](https://app.heygarth.ai/agents/repository-review/repository-setup), select the repository, and open the **Repository Review** tab.
...
| | |
|---|---|
| **Options** | Daily, Weekly, or a custom interval |
